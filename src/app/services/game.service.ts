...
const FIRST_NAMES = ["Rattle", "Spool", "Thread", "Penny", "Green", "Fable", "Myth", "Flag", "String", "Fret", "Bow", "Trick", "Dash", "Dodge", "Flicker", "Candle", "Flame", "Pick", "Pit", "Fern", "Ramble", "Briar", "Thorn", "Root", "Bark", "Petal", "Stem", "Stone", "Rock", "Mulch", "Cob", "Spark", "Jute", "Twine", "Nib", "Candle", "Bee", "Clay", "Bell", "Clover", 'Nettle', 'Daffodil', 'Acorn', 'Oak', 'Leaf', 'Twig', 'Persimmon', 'Cinnamon', 'Blackberry', 'Bramble', 'Thimble', 'Nimble', 'Nettle', 'Eiderdown', 'Teacup', 'Whisper', 'Ripple', 'Ruffle', 'Creek', 'Brook', 'Swift', 'Snapdragon', 'Wicket', 'Wicker', 'Toadstool', 'Morel', 'Flossy', 'Hattie', 'Hazel', 'Willie', 'Cora', 'Whimsy', 'Mint', 'Cardamom', 'Ivy', 'Harper', 'Candle', 'Windy', 'Mica', 'Nutmeg', 'Basil', 'Weatherby', 'Bartleby', 'Daisy', 'Needle', 'Heather', 'Lilac', 'Rosemary', 'Lavender', 'Tea', 'Penny', 'Lace', 'Pearl'];
const LAST_NAMES = ["Chatterby", "Copperpot", "Yarn", "Cowlick", "Haypenny", "Fields", "Meadows", "Lyrical", "Cattail", "Milkweed", "Cornsilk", "Hayseed", "Burrow", "Thicket", "Warren", "Timber", "Potter", "Cottage", "Calico", "Gingham", "Picnic", "Dogwood", "Milkweed", "Fiddlehead", "Husk", "Sparkles", "Moonglow", "Starlight", "Sparkles", "Mill", "Cobbler", "Jam", "Reflection", "Preserve", 'Thistledown', 'Babble', 'Willow-Whistle', "Whistle", 'Codswallop', 'Cobblestone', 'Cobblepot', 'Swallowtail', 'Witchhazel', 'Arrowroot', 'Drifter', 'Puddle', 'Muddle', 'Tealeaf', 'Teatree', 'Treeleaf', 'Chamomile', 'Root', 'Wither', 'Hither', 'Thither', 'Willow', 'Woods', 'Path', 'Fog', 'Marsh', 'Branch', 'Fiddle', 'Hearth', 'Candlestick', 'Meadows', 'Rivulet', 'Tarragon', 'Campside', 'Riverside', 'Lakeside', 'Shore', 'Cotton', 'Wool', 'Seedpod', 'Needlepoint', 'Pincushion', 'Larkspur', 'Tin', 'Tatter', 'Hook', 'Weather', 'Basket'];
